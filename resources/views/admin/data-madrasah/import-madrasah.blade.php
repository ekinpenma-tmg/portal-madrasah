...
<div class="max-w-xl fade-in">
    ...
    <div class="flex items-center gap-2 text-xs text-zinc-400 mb-4">
        ...
        <span class="text-zinc-600 font-medium">Import Data Madrasah</span>
    </div>
    ...
    <div class="bg-white rounded-xl border border-zinc-100 p-4 mb-4">
        <div class="flex items-start justify-between gap-3 mb-3">
            <div>
                ...
                <p class="text-2xs text-zinc-400 mt-0.5">Nama kolom tidak case-sensitive. Baris pertama harus header. Sumber: Excel EMIS.</p>
            </div>
            <a href="{{ route('admin.data-madrasah.import-madrasah.template') }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
            <div class="flex items-center gap-2 bg-green-50 border border-green-100 rounded-lg px-3 py-2">
                ...
                <div>
                    ...
                    <p class="text-2xs text-zinc-400">Nomor statistik madrasah</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-green-50 border border-green-100 rounded-lg px-3 py-2">
                <span class="badge badge-green flex-shrink-0">Wajib</span>
                <div>
                    ...
                    <p class="text-2xs text-zinc-400">Nama satuan pendidikan</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                ...
                <div>
                    <p class="text-xs font-semibold text-zinc-700">NPSN</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                <span class="badge badge-gray flex-shrink-0">Opsional</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Jenjang</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                <span class="badge badge-gray flex-shrink-0">Opsional</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Status</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                <span class="badge badge-gray flex-shrink-0">Opsional</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Kecamatan</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                <span class="badge badge-gray flex-shrink-0">Opsional</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Alamat</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                <span class="badge badge-gray flex-shrink-0">Opsional</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Akreditasi</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                <span class="badge badge-gray flex-shrink-0">Opsional</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Nama Kepala</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-zinc-100 p-5">
        <form method="POST" action="{{ route('admin.data-madrasah.import-madrasah.store') }}" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                <label class="block text-2xs font-semibold text-zinc-500 mb-2 uppercase tracking-wider">
                    File Excel EMIS <span class="text-red-500">*</span>
                </label>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="tahun_data" value="{{ old('tahun_data', date('Y')) }}"
                    placeholder="Contoh: 2024"
                    class="border border-zinc-200 rounded-lg px-3 py-1.5 text-xs w-32 focus:ring-1 focus:ring-zinc-300 focus:outline-none">
                @error('tahun_data') <p class="text-red-500 text-2xs mt-1">{{ $message }}</p> @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="space-y-2">
                    <label class="flex items-start gap-2.5 p-3 border rounded-lg cursor-pointer transition"
                           :class="$refs.modeReplace?.checked ? 'border-zinc-400 bg-zinc-50' : 'border-zinc-200 hover:bg-zinc-50'">
                        <input type="radio" name="mode" value="replace" checked x-ref="modeReplace" class="mt-0.5 accent-zinc-800 flex-shrink-0">
                        <div>
                            <p class="text-xs font-semibold text-zinc-800">Ganti Semua (Replace)</p>
                            <p class="text-2xs text-zinc-500 mt-0.5">NSM di file akan diperbarui/ditambahkan. NSM lama yang tidak ada di file baru akan <strong>dinonaktifkan</strong> (bukan dihapus) — arsip dan akun madrasah tetap aman. Cocok untuk pembaruan tahunan.</p>
                        </div>
                    </label>
                    <label class="flex items-start gap-2.5 p-3 border border-zinc-200 rounded-lg cursor-pointer hover:bg-zinc-50 transition">
                        <input type="radio" name="mode" value="append" class="mt-0.5 accent-zinc-800 flex-shrink-0">
                        <div>
                            <p class="text-xs font-semibold text-zinc-800">Tambah / Update (Upsert)</p>
                            <p class="text-2xs text-zinc-500 mt-0.5">Data lama tetap ada apa adanya. NSM sama akan diperbarui, data baru ditambahkan. Tidak ada madrasah yang dinonaktifkan.</p>
                        </div>
                    </label>
                </div>
