...
<div class="max-w-xl">
    ...
    <div class="flex items-center gap-2.5 mb-4 fade-in">
        ...
        <div>
            <h1 class="text-sm font-semibold text-zinc-900">Tambah Layanan</h1>
            <p class="text-xs text-zinc-400 mt-0.5">Tambahkan jenis pelayanan baru untuk ditampilkan di halaman publik</p>
        </div>
    </div>
