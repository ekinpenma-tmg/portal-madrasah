...
<div class="max-w-md mx-auto">
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 pt-6 pb-5 text-center bg-primary-700">
            <div class="w-11 h-11 bg-white/15 rounded-xl flex items-center justify-center mx-auto mb-3">
                <svg class="w-[22px] h-[22px] text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
            </div>
            <p class="text-white font-semibold text-base">Pengajuan Terkirim</p>
            <p class="text-primary-100 text-xs mt-1">Dokumen Anda sedang menunggu diproses</p>
        </div>
        ...
        <div class="p-5">
            <div class="rounded-lg px-4 py-3 mb-4 text-center" style="background:#f0fdf4; border:1.5px dashed #86efac">
                ...
                <p class="text-xl font-bold text-primary-700 tracking-widest font-mono">{{ $pengajuan->kode_ajuan }}</p>
            </div>
            ...
            <div class="flex gap-2">
                <a href="{{ route('guru.pengajuan.riwayat') }}" class="flex-1 text-center bg-primary-700 hover:bg-primary-800 text-white text-sm font-medium py-3 rounded-lg transition">Lihat Riwayat</a>
                <a href="{{ route('guru.dashboard') }}" class="flex-1 text-center bg-gray-100 hover:bg-gray-200 text-gray-600 text-sm font-medium py-3 rounded-lg transition">Dashboard</a>
            </div>
        </div>
    </div>
</div>
