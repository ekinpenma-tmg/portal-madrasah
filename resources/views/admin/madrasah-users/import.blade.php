...
@section('title', 'Import Akun Madrasah')
...
<div class="max-w-xl fade-in">
    ...
    <div class="bg-white rounded-xl border border-zinc-100 p-4 mb-4">
        <div class="flex items-start justify-between gap-3 mb-3">
            ...
            <a href="{{ route('admin.madrasah-users.download-template') }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-1.5">
            <div class="flex items-center gap-2 bg-green-50 border border-green-100 rounded-lg px-3 py-2">
                ...
                <div>
                    ...
                    <p class="text-2xs text-zinc-400">Harus sudah ada di Data Madrasah</p>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-green-50 border border-green-100 rounded-lg px-3 py-2">
                <span class="badge badge-green flex-shrink-0">Wajib</span>
                <div>
                    <p class="text-xs font-semibold text-zinc-700">Nama PIC</p>
                    <p class="text-2xs text-zinc-400">Penanggung jawab akun</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 bg-zinc-50 border border-zinc-100 rounded-lg px-3 py-2">
                ...
                <div>
                    ...
                    <p class="text-2xs text-zinc-400">HP/WhatsApp PIC</p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-3 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2 flex items-start gap-2">
            ...
            <p class="text-2xs text-blue-600">NSM harus sudah terdaftar di Data Madrasah. Madrasah yang sudah punya akun dilewati otomatis. Password default = <strong>NSM</strong>.</p>
        </div>
    </div>

    {{-- Form upload --}}
    <div class="bg-white rounded-xl border border-zinc-100 p-5">
        <form method="POST" action="{{ route('admin.madrasah-users.import') }}" enctype="multipart/form-data"
            ...
            <div class="mb-5">
                ...
                <div class="space-y-2">
                    <label class="flex items-start gap-2.5 p-3 border border-zinc-200 rounded-lg cursor-pointer hover:bg-zinc-50 transition">
                        <input type="radio" name="mode" value="skip" checked class="mt-0.5 accent-zinc-800 flex-shrink-0">
                        <div>
                            <p class="text-xs font-semibold text-zinc-800">Lewati yang sudah ada</p>
                            <p class="text-2xs text-zinc-500 mt-0.5">NSM yang sudah punya akun akan dilewati, akun baru tetap ditambahkan. <strong>Aman untuk import pertama.</strong></p>
                        </div>
                    </label>
                    <label class="flex items-start gap-2.5 p-3 border border-zinc-200 rounded-lg cursor-pointer hover:bg-zinc-50 transition">
                        ...
                        <div>
                            ...
                            <p class="text-2xs text-zinc-500 mt-0.5">Nama PIC/Email/No HP akun yang sudah ada akan diperbarui dari file. Password & status aktif tidak berubah.</p>
                        </div>
                    </label>
                </div>
